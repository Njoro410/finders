...
<div id="home">
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<form action="adultsearch.php" method="POST" class="form-inline my-2 my-lg-0"> <input class="form-control mr-sm-2" type="text" name = "name" placeholder="Search Adult Victim"> <button class="btn btn-success my-2 my-sm-0" type="submit" name="search" target="_blank" >Search</button> </form>
		</div>
	</div>
	</nav>
	<!--End navigation-->
