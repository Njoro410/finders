    ...
    <div class="narrow text-center">
        ...
        <div class="row text-center">
            <div class="col-md-2.5">
                <div class="feature">
                    ...
                    shrink-4 up-5"></i></a>
                    <a href="users.php"> <h3>View Users</h3></a>
                </div>
            </div>
        ...
        <div class="col-md-2.5">
                <div class="feature">
                    ...
                    shrink-4 up-5"></i></a>
                    <a href="children.php"> <h3>View Children</h3></a>
        ...
        <div class="col-md-2.5">
                <div class="feature">
                    ...
                    shrink-4 up-5"></i></a>
                    <a href="adults.php"> <h3>View Adults</h3></a>
                </div>
            </div>
             <div class="col-md-2.5">
                <div class="feature">
                    ...
                    shrink-4 up-5"></i></a>
                    <a href="feedback.php"> <h3>View Feedback</h3></a>
                </div>
            </div>
            <div class="col-md-2.5">
                <div class="feature">
                    ...
                    shrink-4 up-5"></i></a>
                    <a href="submit.php"> <h3>Add a request </h3></a>
                </div>
            </div>
        </div><!--end row-->
    </div><!--End narrow-->
...
<div class="container-fluid">
<div class="narrow text-center">
<p class="lead">Adults</p>
</div>


        <div class="col">
            <?php
            $result = $con->query("Select * from adults");
            ...
            <div class="container text-center">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="adults.php?delete=<?php echo $row['id'];?>"
...
<?php
    ...
    {
        $id=$_GET['delete'];
        $con->query("Delete from adults where id=$id");
    }
?>
                    </tr>
                    </tbody>
